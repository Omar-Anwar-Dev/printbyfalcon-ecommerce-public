...
export async function createOrderAction(
  ...
  // governorate) from creating an order we can't fulfill. Throws an error key
  // the form can localize.
  ...
  // Sprint 11.5 — validate the chosen payment method is enabled. Maps form
  // values (PAYMOB_CARD / COD) to PaymentMethodConfig codes (paymob_card /
  // cod). Other methods (Fawry / wallet) aren't yet exposed by the form;
  // when they land, this map gets a new entry.
