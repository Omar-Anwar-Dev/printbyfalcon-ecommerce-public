...
export function AddressManager({
  ...
  // Default governorate of the form: prefer the first deliverable; fall back
  // to CAIRO so the form still renders if (somehow) every governorate has
  // been deactivated by the admin.
  ...
  function startAdd() {
    // Use the first deliverable governorate so the form never pre-fills
    // an undeliverable choice (which would fail at submit).
    setForm({
      ...EMPTY,
